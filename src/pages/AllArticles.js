...
const AllArticles = () => {
  ...
  const articles = [
    ...
    },
    {
      ...
      fullTitle:
        "RMF Leadership engages new DVLA CEO in Strategic Briefing for a Dynamic Reset",
      description:
    ...
    },
    {
      ...
      fullTitle:
        "Hope Restored at Dome Market: RMF, MP, and Deputy Minister Bring Relief to Market Women",
      description:
  ...
  return (
    <>
      ...
      <div className="content">
        <motion.div
          className="articles-all-articles-container"
